module.exports = validationCreateInvitation = (id_client, id_plan, name_invitation)=>{
    let error = {}
    ...
    if(!name_invitation || name_invitation.length < 3) error.name_invitation = "Nombre de invitacion debe contener al menos 3 caracteres"
    if(!name_invitation || name_invitation.length > 20) error.name_invitation = "Nombre de invitacion no puede contener mas de 20 caracteres"
